...
import module.MiddlewareActivity;
...
public class ActivityManager {
    ...
    public static boolean restart(final Context context, boolean confirm) {
        ...
        if(top instanceof MiddlewareActivity) {
            ...
            try {
                ...
                AbuildCore.getSyncInfoSp().edit().putBoolean("callReset", true).commit();
                return true;
    ...
    public static void restartForegroundActivity() {
        Activity foregroundActivity = Restarter.getForegroundActivity(AbuildCore.getApplication());
        Log.d(TAG, "foregroundActivity :" + foregroundActivity+" getTopActivity "+getTopActivity());
